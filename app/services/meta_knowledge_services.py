...
class MetaKnowledgeServices:
    ...
    async def _save_columns_to_qdrant(self, column_infos: list[ColumnInfo]):
        ...
        embedding_batch_size = 20  # 这有个embedding_batch_size参数没有没有放到参数配置文件
