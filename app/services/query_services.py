...
from app.my_agent.graph import graph
...
class QueryService:
    def __init__(self,
                 meta__mysql_repository: MetaMySQLRepository,
                 embedding_client: HuggingFaceEndpointEmbeddings,
                 dw_mysql_repository: DWMySQLRepository,
                 column_qdrant_repository: ColumnQdrantRepository,
                 metric_qdrant_repository: MetricQdrantRepository,
                 vale_es_repository: ValueESRepository):
        self.column_qdrant_repository = column_qdrant_repository
        self.metric_qdrant_repository = metric_qdrant_repository
        self.value_es_repository = vale_es_repository

        self.meta_mysql_repository = meta__mysql_repository
