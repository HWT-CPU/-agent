...
async def get_query_services(
        meta__mysql_repository: Annotated[MetaMySQLRepository, Depends(get_meta_mysql_repository)],
        ...
        vale_es_repository: Annotated[ValueESRepository, Depends(get_value_es_repository)]
) -> QueryService:
    return QueryService(
        meta__mysql_repository=meta__mysql_repository,
        embedding_client=embedding_client,
        dw_mysql_repository=dw_mysql_repository,
        column_qdrant_repository=column_qdrant_repository,
        metric_qdrant_repository=metric_qdrant_repository,
        vale_es_repository=vale_es_repository
    )